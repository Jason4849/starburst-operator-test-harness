...
ENV PKG=/go/src/github.com/Jooho/starburst-operator-test-harness/
ENV HOME /tmp
...
COPY --from=builder /go/src/github.com/Jooho/starburst-operator-test-harness/operator-test-harness.test  operator-test-harness.test
